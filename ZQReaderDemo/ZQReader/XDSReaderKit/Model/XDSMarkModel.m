...
NSString *const kMarkModelChapterNameEncodeKey = @"chapterName";
...
-(void)encodeWithCoder:(NSCoder *)aCoder{
    ...
    [aCoder encodeObject:self.chapterName forKey:kMarkModelChapterNameEncodeKey];
...
-(id)initWithCoder:(NSCoder *)aDecoder{
    ...
    if (self) {
        ...
        self.chapterName = [aDecoder decodeObjectForKey:kMarkModelChapterNameEncodeKey];
